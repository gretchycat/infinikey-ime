...
import com.infinikey_ime.model.DimensionValue
import com.infinikey_ime.model.KeyAction
import com.infinikey_ime.model.KeyDefinition
import com.infinikey_ime.model.KeyRow
import com.infinikey_ime.model.LayoutDefinition
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.infinikey_ime.util.FontFallbackManager.applyToView(findViewById(android.R.id.content))
        ...
        val initialFormIdx = when (currentFormFactor) {
            ...
            "RIGHT_DOCKED" -> 3
            "FLOATING" -> if (com.infinikey_ime.BuildConfig.DEBUG) 4 else 0
            else -> 0
        }
        ...
        spFormFactor.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                val mode = when (position) {
                    ...
                    2 -> "LEFT_DOCKED"
                    3 -> "RIGHT_DOCKED"
                    4 -> if (com.infinikey_ime.BuildConfig.DEBUG) "FLOATING" else "FULL_WIDTH_DOCKED"
                    else -> "FULL_WIDTH_DOCKED"
                }

                if (mode == "FLOATING") {
                    if (!com.infinikey_ime.util.OverlayPermissionUtil.hasOverlayPermission(this@SettingsActivity)) {
                        com.infinikey_ime.util.OverlayPermissionUtil.requestOverlayPermission(this@SettingsActivity)
                    }
                }
        ...
        fun showColorPickerDialog(targetEditText: EditText, targetButton: android.widget.Button) {
            ...
            com.infinikey_ime.util.FontFallbackManager.applyToView(dialogView)
        ...
        fun getUserThemesDir(): java.io.File {
            ...
            return com.infinikey_ime.util.ThemeManager.getUserThemesDir(this)
        }
        ...
        fun syncDefaultLayoutsToFolder() {
            com.infinikey_ime.util.IconRenderer.getUserIconsDir(this)
            com.infinikey_ime.engine.LayoutParser.syncAndUpgradeDefaultLayouts(this)
        }
        ...
        fun loadLayoutEntries(): MutableList<LayoutSelectorEntry> {
            com.infinikey_ime.engine.LayoutParser.syncAndUpgradeDefaultLayouts(this@SettingsActivity)
            ...
            for (file in defaultAssetFiles) {
                ...
                val loaded = try {
                    if (currentFileJson.isNotEmpty()) {
                        com.infinikey_ime.engine.LayoutParser.parseJsonLayoutDescriptor(currentFileJson)
                    } else if (!customJsonPref.isNullOrEmpty()) {
                        com.infinikey_ime.engine.LayoutParser.parseJsonLayoutDescriptor(customJsonPref)
                    } else {
        ...
        fun showCreateEmptyLayoutDialog() {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Create") { _, _ ->
                    ...
                    val newLayout = com.infinikey_ime.model.LayoutDefinition(
                        id = targetId,
                        name = layoutName,
                        version = com.infinikey_ime.BuildConfig.VERSION_NAME,
                        author = "User Custom",
                        description = "Custom layout created by user.",
                        metadata = com.infinikey_ime.model.LayoutMetadata(
                            horizontalSpacing = com.infinikey_ime.model.DimensionValue.Absolute(4),
                            verticalSpacing = com.infinikey_ime.model.DimensionValue.Absolute(4),
                            defaultScreenMode = "FULL_WIDTH_DOCKED",
                            defaultHeightPercentage = 30,
                            showKeyPreview = true
                        ),
                        rows = listOf(
                            com.infinikey_ime.model.KeyRow(
                                id = 1,
                                keys = listOf(
                                    com.infinikey_ime.model.KeyDefinition(
                                        primaryLabel = "Key 1",
                                        widthWeight = com.infinikey_ime.model.DimensionValue.Ratio(1.0f),
                                        styleName = "alphaKey",
                                        onPressAction = com.infinikey_ime.model.KeyAction.SendText("Key 1")
                                    )
                                )
                            ),
                            com.infinikey_ime.model.KeyRow(
                                ...
                                keys = listOf(
                                    com.infinikey_ime.model.KeyDefinition(
                                        primaryLabel = "⌨ Main",
                                        widthWeight = com.infinikey_ime.model.DimensionValue.Ratio(1.5f),
                                        styleName = "modifierKey",
                                        onPressAction = com.infinikey_ime.model.KeyAction.SwitchLayout("main")
                                    ),
                                    com.infinikey_ime.model.KeyDefinition(
                                        primaryLabel = "␣",
                                        widthWeight = com.infinikey_ime.model.DimensionValue.Ratio(3.0f),
                                        styleName = "alphaKey",
                                        onPressAction = com.infinikey_ime.model.KeyAction.SendText(" ")
                                    ),
                                    com.infinikey_ime.model.KeyDefinition(
                                        primaryLabel = "⌫",
                                        widthWeight = com.infinikey_ime.model.DimensionValue.Ratio(1.5f),
                                        styleName = "actionKey",
                                        onPressAction = com.infinikey_ime.model.KeyAction.SendCode(android.view.KeyEvent.KEYCODE_DEL)
                                    )
                                )
                            )
                        )
        ...
        fun updateFormFactorButtons(selectedMode: com.infinikey_ime.model.FormFactorMode) {
            ...
            btnPreviewFullWidth.backgroundTintList = if (selectedMode == com.infinikey_ime.model.FormFactorMode.FULL_WIDTH_DOCKED) activeColor else inactiveColor
            btnPreviewLeftDocked.backgroundTintList = if (selectedMode == com.infinikey_ime.model.FormFactorMode.LEFT_DOCKED) activeColor else inactiveColor
            btnPreviewRightDocked.backgroundTintList = if (selectedMode == com.infinikey_ime.model.FormFactorMode.RIGHT_DOCKED) activeColor else inactiveColor
            btnPreviewSplitScreen.backgroundTintList = if (selectedMode == com.infinikey_ime.model.FormFactorMode.SPLIT) activeColor else inactiveColor
        ...
        btnPreviewFullWidth.setOnClickListener { updateFormFactorButtons(com.infinikey_ime.model.FormFactorMode.FULL_WIDTH_DOCKED) }
        btnPreviewLeftDocked.setOnClickListener { updateFormFactorButtons(com.infinikey_ime.model.FormFactorMode.LEFT_DOCKED) }
        btnPreviewRightDocked.setOnClickListener { updateFormFactorButtons(com.infinikey_ime.model.FormFactorMode.RIGHT_DOCKED) }
        btnPreviewSplitScreen.setOnClickListener { updateFormFactorButtons(com.infinikey_ime.model.FormFactorMode.SPLIT) }
        ...
        browseKeyImageLauncher = registerForActivityResult(ActivityResultContracts.GetContent()) { uri: Uri? ->
            uri?.let {
                val savedPath = com.infinikey_ime.util.IconRenderer.saveUserIcon(this, it)
        ...
        btnLaunchFilesApp.setOnClickListener {
            ...
            // 1. Try launching directly into Android/data/com.infinikey_ime/files/layouts folder using SAF Document URI
            try {
            ...
            if (!launched) {
                // 2. Try launching into Android/data/com.infinikey_ime/files
                try {
    ...
    private fun showKeyEditorDialog(
        ...
        com.infinikey_ime.util.FontFallbackManager.applyToView(view)
        ...
        fun populateIconSpinner(selectedPath: String?) {
            ...
            val userIcons = com.infinikey_ime.util.IconRenderer.getUserCustomIcons(this)
    ...
    private fun serializeStyle(style: com.infinikey_ime.model.KeyStyle): com.google.gson.JsonObject {
        val obj = com.google.gson.JsonObject()
    ...
    private fun setupSpeechToTextTab(prefs: android.content.SharedPreferences) {
        ...
        val tvSttStatusIndicatorLight = findViewById<TextView>(R.id.tvSttStatusIndicatorLight)
        val tvSttStatusTitle = findViewById<TextView>(R.id.tvSttStatusTitle)
        ...
        // 2. Engine-to-Models Compatibility Mapping
        val modelsByEngine = mapOf(
            "ANDROID_SYSTEM" to listOf(
                Pair("System Built-in Model (Google Voice / On-Device)", "SYSTEM_BUILTIN")
            ),
            "SHERPA_ONNX" to listOf(
                Pair("sherpa-onnx-zipformer-en-2023-06-26 (Installed)", "SHERPA_ZIPFORMER_EN"),
                Pair("sherpa-onnx-streaming-bilingual-zh-en (Installed)", "SHERPA_BILINGUAL"),
                Pair("➕ Import Custom .onnx Model...", "IMPORT_CUSTOM")
            ),
            "WHISPER_CPP" to listOf(
                Pair("whisper-tiny.en.gguf (Installed)", "WHISPER_TINY_EN"),
                Pair("whisper-base.en.gguf (Installed)", "WHISPER_BASE_EN"),
                Pair("whisper-small.en.gguf (Installed)", "WHISPER_SMALL_EN"),
                Pair("➕ Import Custom .gguf Model...", "IMPORT_CUSTOM")
            ),
            "CLOUD_API" to listOf(
                Pair("Groq Whisper Large v3 (Cloud API)", "GROQ_WHISPER_V3"),
                Pair("OpenAI Whisper API (Cloud API)", "OPENAI_WHISPER_API"),
                Pair("Vosk Small English (Cloud API)", "VOSK_SMALL_EN"),
                Pair("➕ Configure Custom Cloud Endpoint...", "IMPORT_CUSTOM")
            )
        )

        var currentModelOptions = modelsByEngine[savedEngineKey] ?: modelsByEngine["ANDROID_SYSTEM"]!!
        var modelAdapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, currentModelOptions.map { it.first })
        ...
        val savedModelIdx = currentModelOptions.indexOfFirst { it.second == savedModelKey }.coerceAtLeast(0)
        ...
        var isUpdatingSpinner = false

        spSttEngine.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                val selectedEngineKey = engineOptions.getOrNull(position)?.second ?: "ANDROID_SYSTEM"
                prefs.edit().putString("pref_stt_engine", selectedEngineKey).apply()

                // Filter model options to only show compatible models for this engine
                isUpdatingSpinner = true
                currentModelOptions = modelsByEngine[selectedEngineKey] ?: modelsByEngine["ANDROID_SYSTEM"]!!
                modelAdapter = ArrayAdapter(this@SettingsActivity, android.R.layout.simple_spinner_item, currentModelOptions.map { it.first })
                modelAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
                spSttModel.adapter = modelAdapter

                val lastSavedModelKey = prefs.getString("pref_stt_model", "") ?: ""
                var newModelIdx = currentModelOptions.indexOfFirst { it.second == lastSavedModelKey }
                if (newModelIdx < 0) newModelIdx = 0

                spSttModel.setSelection(newModelIdx)
                val selectedModelKey = currentModelOptions[newModelIdx].second
                prefs.edit().putString("pref_stt_model", selectedModelKey).apply()
                isUpdatingSpinner = false

                updateSttUI(selectedEngineKey, selectedModelKey)
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {}
        }
        ...
        spSttModel.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                val selectedModelKey = currentModelOptions.getOrNull(position)?.second ?: "SYSTEM_BUILTIN"
                prefs.edit().putString("pref_stt_model", selectedModelKey).apply()
        ...
        // 3. Dictation Behavior CheckBoxes
        cbSttContinuousMode?.isChecked = prefs.getBoolean("pref_stt_continuous_mode", false)
