...
import com.infinikey_ime.model.KeyStyle
import com.infinikey_ime.model.LayoutDefinition
import com.infinikey_ime.model.LayoutMetadata
import com.infinikey_ime.model.LayoutTheme
...
object LayoutParser {
    ...
    fun loadThemePresetFromAssets(context: Context, themeName: String): Pair<LayoutTheme?, Map<String, KeyStyle>> {
        return try {
            val jsonStr = com.infinikey_ime.util.ThemeManager.loadThemeJson(context, themeName)
