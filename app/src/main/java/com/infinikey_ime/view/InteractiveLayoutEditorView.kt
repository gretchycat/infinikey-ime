...
class InteractiveLayoutEditorView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        keyBoundsList.forEach { kb ->
            ...
            com.infinikey_ime.util.FontFallbackManager.applyToPaint(textPaint, kb.key.primaryLabel)
            ...
            if (!kb.key.secondaryLabel.isNullOrEmpty()) {
                ...
                com.infinikey_ime.util.FontFallbackManager.applyToPaint(subTextPaint, kb.key.secondaryLabel)
